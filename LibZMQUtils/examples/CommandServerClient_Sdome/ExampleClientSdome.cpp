...
/** ********************************************************************************************************************
 * @example ExampleClientSdome.cpp
 *
 * @brief This file serves as a program example of how to use the `SdomeClient` class.
 *
 * This program initializes an instance of the `SdomeClient` class to interact with an `SdomeServer`.
 *
...
// PROJECT INCLUDES
// =====================================================================================================================
#include "SdomeController/common.h"
#include "SdomeServer/common.h"
#include "SdomeClient/sdome_client.h"
// =====================================================================================================================


// TODO Remove
using namespace zmqutils;
using namespace sdome;
using namespace sdome::communication;
using namespace sdome::communication::common;
using namespace sdome::controller;
...
void parseCommand(CommandClientBase &client, const std::string &command)
{
    ...
    if (token)
    {
        ...
        else if (command_id == static_cast<CommandType>(SdomeServerCommand::REQ_GET_DATETIME))
        {
            std::cout << "Get datetime command not implemented yet." << std::endl;
            valid = false;
        }
        else if (command_id == static_cast<CommandType>(SdomeServerCommand::REQ_SET_DATETIME))
        {
            std::cout << "Set datetime command not implemented yet." << std::endl;
            valid = false;
        }
        else if (command_id == static_cast<CommandType>(SdomeServerCommand::REQ_GET_HOME_POSITION))
        {
            std::cout << "Sending get home position command." << std::endl;
        }
        else if (command_id == static_cast<CommandType>(SdomeServerCommand::REQ_SET_HOME_POSITION))
        {
        ...
        if (valid)
        {
            ...
            {
                constexpr std::size_t res_sz = sizeof(sdome::controller::ControllerError);
                ...
                if (command_id == static_cast<CommandType>(SdomeServerCommand::REQ_GET_HOME_POSITION))
                {
                    try
                    {
...
/**
 * @brief Main entry point of the program `ExampleClientSdome`.
 */
int main(int, char**)
{
    ...
    SdomeClient client(endpoint, "SDOME EXAMPLE CLIENT");
