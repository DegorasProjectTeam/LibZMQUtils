...
/** ********************************************************************************************************************
 * @file sdome_server.h
 * @brief EXAMPLE FILE - This file contains the declaration of the SdomeServer example class.
...
class SdomeServer : public zmqutils::ClbkCommandServerBase
{
public:

    SdomeServer(unsigned port, const std::string& local_addr = "*");

    // Register callback function helper.
    template<typename... Args>
    void registerControllerCallback(SdomeServerCommand command,
                                    controller::SdomeController* object,
                                    controller::SdomeControllerCallback<Args...> callback)
    {
...
private:
    ...
    using SdomeRequestProcFunc = void(SdomeServer::*)(const CommandRequest&, CommandReply&);
    // -----------------------------------------------------------------------------------------------------------------
    ...
    void registerRequestProcFunc(SdomeServerCommand command, SdomeRequestProcFunc func);
